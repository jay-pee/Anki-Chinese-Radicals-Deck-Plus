# coding:utf-8
"""
This file is taken from hanzipy library. A bug is fixed in the function
'get_characters_with_component()' to ignore key error when searching for fitting
characters
"""
...
CURRENT_DIR = BASE_DIR = Path(hanzipy.__file__).parent
